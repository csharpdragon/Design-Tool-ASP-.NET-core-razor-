...
var jsc = {
	...
	pub : function (targetElement, opts) {
		...
		this.exposeColor = function (flags) {
			...
			$(this.targetElement).trigger('updated', this.toRGBAString());
		...
		function initSetColor(_value) {
			THIS.fromString(_value, jsc.flags.leaveValue);
		...
		$(this.targetElement).on('initColorSet', function (_event, _value) {
			initSetColor(_value);
		});
//		if($($(this.targetElement).parent()).attr('id') == 'btn_image_border_color'){
